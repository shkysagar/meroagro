    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-xs-12 col-sm-8">
                <div class="footer-logo pull-left"><img src="<?= get_template_directory_uri(); ?>/img/footer-agro-logo.png"
                                                        alt=""/></div>
    ...
    <div class="container">
        ...
        <div class="row coppy">
            ...
            <div class="col-md-6 text-right">
                <p>Crafted with <i class="fa fa-heart fa-pulse"></i> in <a href="https://arctechnepal.com">Kathmandu</a></p>
            </div>
        </div>
...
<script type="text/javascript" src="<?= get_template_directory_uri(); ?>/js/magnific-popup/jquery.magnific-popup.min.js"></script>
