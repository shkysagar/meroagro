                    ...
                    <div class="col-md-4 col-sm-6 blog-masonry-item">
                        <div class="item-inner">
                            ...
                            <div class="post-title">
                                <a download="<?php the_cfc_field( 'download_img','download_image_title', false, $key );?>" href="<?php the_cfc_field( 'download_img','download_image', false, $key ); ?>" title="ImageName">
  

                                <img alt="Blog Preview" src="<?php the_cfc_field( 'download_img','download_image', false, $key ); ?>" />
                               </a> <hr/>
